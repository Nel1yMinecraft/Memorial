...
import me.memorial.utils.math.toRadians
import me.memorial.utils.render.ColorUtils
import me.memorial.utils.render.ColorUtils.LiquidSlowly
import me.memorial.utils.render.ColorUtils.fade
import me.memorial.utils.render.Render
...
class JumpCircle : Module() {
    ...
    class Circle(val time: Long, val x: Double, val y: Double, val z: Double){
        ...
        val jumpModule = Memorial.moduleManager.getModule(JumpCircle::class.java) as JumpCircle

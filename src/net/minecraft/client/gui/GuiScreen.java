...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawLunarBackground(int mouseX, int mouseY,Float partialTicks,ResourceLocation backgroundTexture)
    {
        GlStateManager.disableAlpha();
        renderSkybox(mouseX,mouseY,partialTicks,backgroundTexture);
    ...
    private void rotateAndBlurSkybox(float p_73968_1_,ResourceLocation backgroundTexture)
    {
    ...
    private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_, ResourceLocation backgroundTexture)
    {
        this.mc.getFramebuffer().unbindFramebuffer();
        GlStateManager.viewport(0, 0, 256, 256);
        this.drawPanorama(p_73971_1_, p_73971_2_, p_73971_3_);
        this.rotateAndBlurSkybox(p_73971_3_,backgroundTexture);
        this.rotateAndBlurSkybox(p_73971_3_,backgroundTexture);
        this.rotateAndBlurSkybox(p_73971_3_,backgroundTexture);
        this.rotateAndBlurSkybox(p_73971_3_,backgroundTexture);
        this.rotateAndBlurSkybox(p_73971_3_,backgroundTexture);

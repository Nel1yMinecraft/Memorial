...
import me.memorial.special.AutoReconnect;
...
import me.memorial.ui.client.altmanager.sub.GuiDonatorCape;
...
public class ValuesConfig extends FileConfig {
    ...
    protected void loadConfig() throws IOException {
        ...
        while(iterator.hasNext()) {
            ...
            if (entry.getKey().equalsIgnoreCase("CommandPrefix")) {
                Memorial.commandManager.setPrefix(entry.getValue().getAsCharacter());
    ...
    protected void saveConfig() throws IOException {
        ...
        jsonObject.addProperty("CommandPrefix", Memorial.commandManager.getPrefix());
        ...
        Memorial.moduleManager.getModules().stream().filter(module -> !module.getValues().isEmpty()).forEach(module -> {

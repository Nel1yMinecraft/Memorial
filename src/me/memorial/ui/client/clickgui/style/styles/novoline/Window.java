package me.memorial.ui.client.clickgui.style.styles.novoline;
...
import me.memorial.utils.Translate;
...
public class Window {
    ...
    public final ArrayList<me.memorial.ui.client.clickgui.style.styles.novoline.Button> buttons = Lists.newArrayList();
    public boolean drag;
    ...
    public Window(ModuleCategory category, int x, int y) {
        ...
        max = 120;
        int y2 = y + 22;
        for (Module c : Memorial.moduleManager.getModules()) {
            if (c.getCategory() != category)
                continue;
            buttons.add(new me.memorial.ui.client.clickgui.style.styles.novoline.Button(c, x + 5, y2));
            y2 += 15;//15
        }
        for (me.memorial.ui.client.clickgui.style.styles.novoline.Button b2 : buttons) {
            b2.setParent(this);
        }
    }
    int wheely;
    ...
    public void render(int mouseX, int mouseY) {
        ...
        int iY = y + 22;
        totalY = 17;
        for (me.memorial.ui.client.clickgui.style.styles.novoline.Button b3 : buttons) {

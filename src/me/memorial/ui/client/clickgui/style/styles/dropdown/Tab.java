...
public class Tab {
    ...
    public Tab(ModuleCategory enumModuleType, float posX, float posY) {
        ...
        this.posX = posX;
        this.posY = posY;
        for (me.memorial.module.Module abstractModule : Memorial.moduleManager.getModuleInCategory(enumModuleType)) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Fonts.font35.drawString(enumModuleType.name().charAt(0) + enumModuleType.name().substring(1).toLowerCase(), posX + 4, posY + 4, 0xffffffff, true);
        if (opened) {

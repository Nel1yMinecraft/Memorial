...
public class Setting {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        int y = getY();
        HUD hud = (HUD) Memorial.moduleManager.getModule(HUD.class);
        ...
        if (setting instanceof FloatValue) {
            ...
            Fonts.font35.drawString(numberValue.getName() + " " + rounded, module.tab.getPosX() + 4, y + 5.5f, 0xffffffff, true);
        ...
        if (setting instanceof IntegerValue) {
            ...
            RenderUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 99, y + 14, new Color(0, 0, 0, 50).getRGB());
            RenderUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 1 + 98 * percent, y + 14, ClickGUI.generateColor());
            Fonts.font35.drawString(integerValue.getName() + " " + rounded, module.tab.getPosX() + 4, y + 5.5f, 0xffffffff, true);
        ...
        if (setting instanceof BoolValue) {
            ...
            Fonts.font35.drawString(boolValue.getName(), module.tab.getPosX() + 4, y + 5.5f,
                    new Color(227, 227, 227, 255).getRGB(), true);

        }
        if (setting instanceof ListValue) {
            final ListValue listValue = (ListValue) setting;
            Fonts.font35.drawString(listValue.getName(), module.tab.getPosX() + 3, (float) (y + 6),
                    0xffffffff, true);
            Fonts.font35.drawString(listValue.get().toUpperCase(),
                    module.tab.getPosX() + 97 - Fonts.font35.getStringWidth(listValue.get().toUpperCase()), y + 7f,
       ...
       if (setting instanceof TextValue){
        ...
        RenderUtils.drawRect(module.tab.getPosX() + 6, (float) (y + 16), module.tab.getPosX() + 84, (float) (y + 16.5), new Color(195, 195, 195, 220).getRGB());
           Fonts.font35.drawString(textValue.getName(), module.tab.getPosX() + 5.5f, y + 1.5f, new Color(227, 227, 227, 255).getRGB());

        if (Fonts.font35.getStringWidth(s) > 65) {
            Fonts.font35.drawString(Fonts.font35.trimStringToWidth(s, 78, true), module.tab.getPosX() + 6, y + 10, 0xFFFFFFFF);
        } else {
            Fonts.font35.drawString(s, module.tab.getPosX() + 6, y + 10, 0xFFFFFFFF);
        }
        ...
        if (setting instanceof IntegerValue){}
          ...
          /*
            case BINDABLE:
                ...
                return mouseX >= module.tab.getPosX() + 97.5f - Fonts.font35.stringWidth(key) && mouseX <= module.tab.getPosX() + 97.5f && mouseY >= y + 4 && mouseY <= y + 14;

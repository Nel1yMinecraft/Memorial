...
public class Module {
    private final me.memorial.module.Module module;
    ...
    public Module(me.memorial.module.Module module, Tab tab) {
        this.module = module;
        this.tab = tab;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Fonts.font35.drawString(module.getName(), tab.getPosX() + 2, (float) (y + 4), 0xffffffff, true);
            ...
            switch (mouseButton) {
                ...
                case 1:
                    if (!module.getValues().isEmpty()) {
                        final ClickGUI clickGUI = (ClickGUI) Memorial.moduleManager.getModule(ClickGUI.class);
    ...
    public me.memorial.module.Module getModule() {
        return module;
    }
}

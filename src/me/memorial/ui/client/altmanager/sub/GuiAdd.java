...
import me.memorial.ui.elements.GuiPasswordField;
import me.memorial.ui.font.Fonts;
import me.memorial.utils.ClientUtils;
import me.memorial.utils.TabUtils;
...
public class GuiAdd extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch(button.id) {
            case 0:
                ...
                break;
            case 1:
                if (Memorial.fileManager.accountsConfig.accountExists(username.getText())) {
    ...
    private void addAccount(final String name, final String password) {
        if (Memorial.fileManager.accountsConfig.accountExists(name)) {
            status = "§cThe account has already been added.";
            return;
        }
        ...
        new Thread(() -> {
            ...
            Memorial.fileManager.accountsConfig.getAccounts().add(account);

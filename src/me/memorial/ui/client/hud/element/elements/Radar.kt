...
import me.memorial.module.modules.render.ESP
...
import me.memorial.utils.render.SafeVertexBuffer
import me.memorial.utils.render.shader.shaders.RainbowShader
            ...
            if (entity != null && entity !== mc.thePlayer && EntityUtils.isSelected(entity, false)) {
                ...
                if (triangleMode) {
                    if (useESPColorsValue.get()) {
                        val color = (Memorial.moduleManager[ESP::class.java] as ESP).getColor(entity)

...
import me.memorial.utils.render.shader.shaders.RainbowFontShader
...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    private fun getReplacement(str: String): String? {
        ...
        return when (str) {
            ...
            "clientName" -> Memorial.CLIENT_NAME
            "clientVersion" -> "b${Memorial.CLIENT_VERSION}"
            "clientCreator" -> Memorial.CLIENT_CREATOR

package me.memorial.utils.render.shader.shaders;

import me.memorial.utils.MinecraftInstance;
import me.memorial.utils.render.shader.FramebufferShader;
...
public final class OutlineShader extends FramebufferShader {
    ...
    public void updateUniforms() {
        ...
        GL20.glUniform2f(getUniform("texelSize"), 1F / MinecraftInstance.mc.displayWidth * (radius * quality), 1F / MinecraftInstance.mc.displayHeight * (radius * quality));

...
object ShadowUtils : MinecraftInstance() {
    ...
    private val shadowDirectory = ResourceLocation("shaders/shadow.json")
    ...
    fun initShaderIfRequired(sc: ScaledResolution, strength: Float) {
        ...
        if (lastWidth != width || lastHeight != height
            ...
            shaderGroup = ShaderGroup(mc.textureManager, mc.getResourceManager(), initFramebuffer, shadowDirectory)

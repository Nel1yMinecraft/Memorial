...
import me.memorial.module.modules.misc.Spammer
import me.memorial.utils.misc.HttpUtils.get
import me.memorial.utils.misc.StringUtils
import me.memorial.utils.render.ColorUtils.translateAlternateColorCodes
...
object SettingsUtils {
            ...
            when (args[0]) {
                ...
                "load" -> {
                    ...
                    val url = if (urlRaw.startsWith("http"))
                        ...
                        "${Memorial.CLIENT_CLOUD}/settings/${urlRaw.toLowerCase()}"
                ...
                "targetDead" -> {
                    ...
                    val value = args[2]
                    val module = Memorial.moduleManager.getModule(moduleName)
    ...
    fun generateScript(values: Boolean, binds: Boolean, states: Boolean): String {
        ...
        Memorial.moduleManager.modules.filter {

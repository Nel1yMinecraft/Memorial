...
import me.memorial.command.commands.*
import me.memorial.Memorial
import me.memorial.command.shortcuts.Shortcut
import me.memorial.command.shortcuts.ShortcutParser
...
class CommandManager {
    ...
    fun registerShortcut(name: String, script: String) {
        if (getCommand(name) == null) {
            ...
            Memorial.fileManager.saveConfig(Memorial.fileManager.shortcutsConfig)
        } else {

...
import me.memorial.script.api.*
import me.memorial.script.api.global.Chat
import me.memorial.script.api.global.Item
import me.memorial.script.api.global.Setting
import me.memorial.utils.ClientUtils
import me.memorial.utils.MinecraftInstance
import me.memorial.script.api.ScriptCommand
import me.memorial.script.api.ScriptModule
import me.memorial.script.api.ScriptTab
import java.io.File
import java.util.*
...
class Script(val scriptFile: File) : MinecraftInstance() {
    ...
    init {
        ...
        scriptEngine.put("moduleManager", Memorial.moduleManager)
        scriptEngine.put("commandManager", Memorial.commandManager)
        scriptEngine.put("scriptManager", Memorial.scriptManager)
    ...
    fun registerModule(moduleObject: JSObject, callback: JSObject) {
        ...
        Memorial.moduleManager.registerModule(module)
    ...
    fun registerCommand(commandObject: JSObject, callback: JSObject) {
        ...
        Memorial.commandManager.registerCommand(command)
    ...
    fun onDisable() {
        ...
        registeredModules.forEach { Memorial.moduleManager.unregisterModule(it) }
        registeredCommands.forEach { Memorial.commandManager.unregisterCommand(it) }
    ...
    fun import(scriptFile: String) {
        scriptEngine.eval(File(Memorial.scriptManager.scriptsFolder, scriptFile).readText())
    }

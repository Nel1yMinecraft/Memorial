...
import me.memorial.module.modules.player.AutoTool
import me.memorial.utils.RotationUtils
import me.memorial.utils.block.BlockUtils.getBlock
import me.memorial.utils.block.BlockUtils.getBlockName
import me.memorial.utils.block.BlockUtils.getCenterDistance
import me.memorial.utils.block.BlockUtils.isFullBlock
import me.memorial.utils.extensions.getBlock
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        when {
            ...
            actionValue.get().equals("destroy", true) || surroundings -> {
                // Auto Tool
                val autoTool = Memorial.moduleManager[AutoTool::class.java] as AutoTool
                if (autoTool.state)

...
import me.memorial.utils.block.BlockUtils.searchBlocks
...
class Nuker : Module() {
    ...
    fun onUpdate(event: UpdateEvent) {
        // Block hit delay
        if (blockHitDelay > 0 && !Memorial.moduleManager[FastBreak::class.java]!!.state) {
            blockHitDelay--
            return
        }
        ...
        if (mc.playerController.isNotCreative) {
            ...
            do{
                ...
                // Call auto tool
                val autoTool = Memorial.moduleManager.getModule(AutoTool::class.java) as AutoTool
                if (autoTool.state)

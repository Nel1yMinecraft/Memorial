...
import me.memorial.utils.ArrayUtils;
...
public class XRay extends Module {
    ...
    public XRay(){
        instance = this;
		Memorial.commandManager.registerCommand(new Command("xray", new String[]{}) {
			@Override
					...
					if (args[1].equalsIgnoreCase("add")) {
						if (args.length > 2) {
							try {
								...
								Memorial.fileManager.saveConfig(Memorial.fileManager.xrayConfig);
